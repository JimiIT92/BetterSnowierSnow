...
that the addtions are in line with the plugin philosohpy, which is to bring an almost vanilla experience to players.


# 🖥 Downloads

You can download Better Snowier Snow from the [Spigot page]().
